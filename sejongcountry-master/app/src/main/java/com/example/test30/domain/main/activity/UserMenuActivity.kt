...
import com.example.test30.ApiObject
import com.example.test30.ITEM
import com.example.test30.R
import com.example.test30.WEATHER
import com.example.test30.domain.check_user.CheckUserInterface
import com.example.test30.domain.util.Common
import com.example.test30.domain.util.MySharedPreferences
import com.example.test30.domain.util.adapter.WeatherAdapter1
import com.example.test30.domain.util.adapter.WeatherAdapter2
import com.example.test30.domain.util.model.ModelWeather
