package com.example.test30.domain.board.gongji.activity
...
import com.example.test30.*
import com.example.test30.domain.board.BoardInterface
import com.example.test30.domain.information.InformationInterface
import com.example.test30.domain.main.activity.MainActivity2
import com.example.test30.domain.main.activity.MainActivity3
import com.example.test30.domain.util.FcmInterface
...
class GongjiInsertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(MySharedPreferences.getUserId(this)
                .isNullOrBlank() || MySharedPreferences.getUserPw(this)
                .isNullOrBlank() || MySharedPreferences.getUserType(this).isNullOrBlank()) {
